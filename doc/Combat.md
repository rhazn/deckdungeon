...
If a character has no playable cards in their hand (due to insufficient action points or other restrictions), they must end their activation immediately. This effectively ends their individual character's activation and moves to the next character's activation within the same overall turn.
