...
If a character has no playable cards in their hand (due to insufficient action points or other restrictions), they must end their activation immediately. (This ends that character's individual action and moves to the next character's activation in the turn order.)
